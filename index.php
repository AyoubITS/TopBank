...
<body>
  ...
  <header id="topbar header">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">TopBank</a></h1>
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide5.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">BIENVENUE SUR <span>TopBank</span></h2>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide4.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Welcome to <span>TopBank</span></h2>
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="">Vous devenez client de TopBank</a></h4>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>TopBank</span></strong>. Tous droits réservés
      </div>
    </div>
  </footer><!-- End Footer -->
