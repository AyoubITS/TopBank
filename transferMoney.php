<?php
session_start();
$pdoString = "pgsql:host=postgresql-netlife.alwaysdata.net dbname=netlife_topbank user=netlife password=Sahjsp92";
 ...
 try{
  ...
  if ('POST' === $_SERVER['REQUEST_METHOD'])
  {
    ...
    else
    {
      ...
      $nom = $_POST['nom'];
      $prenom = $_POST['prenom'];
      // le numero de compte qui recois
        ...
        if($info_compte[1] > $montant && $info_compte[1] > 10)
        {
          ...
          if ( $stmt->rowCount() > 0 )
          {
             ...
             // echo $soldeTo[0];
              ...
              // update le compte du client qui recoi
